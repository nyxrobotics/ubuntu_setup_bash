...
if [ -f "cuda-repo-ubuntu1804-10-2-local-10.2.89-440.33.01_1.0-1_amd64.deb" ]; then
    echo "cuda-repo-ubuntu1804-10-2-local-10.2.89-440.33.01_1.0-1_amd64.deb exists."
else
...
sudo apt update
sudo apt --only-upgrade install cuda-repo-ubuntu1804-10-2-local-10.2.89-440.33.01
