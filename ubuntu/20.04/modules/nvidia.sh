...
if [ -f "cuda-repo-ubuntu2004-11-4-local_11.4.1-470.57.02-1_amd64.deb" ]; then
    echo "cuda-repo-ubuntu2004-11-4-local_11.4.1-470.57.02-1_amd64.deb exists."
else
...
sudo apt install -y cuda-drivers cuda-11-4 nvidia-opencl-dev
